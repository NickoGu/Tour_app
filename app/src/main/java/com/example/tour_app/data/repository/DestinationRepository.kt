...
import com.example.tour_app.data.tour.Destination
...
object DestinationRepository {
    ...
    fun getMendoza(): Destination {
        return Destination(
            ...
            listOf(
                ...
                "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/10/3c/2b/f1/p1090956-1-largejpg.jpg",
                "https://i0.wp.com/diariosanrafael.com.ar/wp-content/uploads/2022/07/turismo-mendoza.jpg"
            )
        )
    }
    ...
    fun getMerlo(): Destination {
        return Destination(
            ...
            listOf(
                "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/16/15/a1/31/pasos-malos-circuito.jpg",
                "https://sanluis24.com.ar/wp-content/uploads/2023/01/marli.jpg",
    ...
    fun getTermas(): Destination {
        return Destination(
            ...
            listOf(
                "https://www.turismoentrerios.com/colon/img/termas-01.jpg",
                "https://images.squarespace-cdn.com/content/v1/53eab704e4b0dfc0547d4034/1633806050800-8IJ0VJN8Z6S5SGCI2N5P/Termas1.png",
                "https://media.lacapital.com.ar/p/ef0450cb5f0d625e6ff53cb69f491a3a/adjuntos/203/imagenes/100/113/0100113846/1200x675/smart/parque-destacadajpg.jpg"
            )
        )
    }
    ...
    fun getCordoba(): Destination {
        return Destination(
            ...
            listOf(
                "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/12/6e/55/07/catedral-de-cordoba.jpg",
                "https://www.cordobaturismo.gov.ar/wp-content/uploads/2018/09/Villa-Carlos-Paz.jpg",
                "https://hotelvesubio.com/wp-content/uploads/2022/02/reloj-cucu.jpeg"
            )
        )
    }
    ...
    fun getEsterosDelIbera(): Destination {
        return Destination(
            ...
            listOf(
                "https://www.boomerangviajes.tur.ar/wp-content/uploads/2022/01/Travesia-en-Kayak-por-Esteros-1067x800.jpg",
                "https://www.cambacuaibera.com.ar/images/home/Home2.jpg",
                "https://media-cdn.tripadvisor.com/media/photo-s/07/a9/7c/62/esteros-del-ibera.jpg"
            )
        )
    }
    ...
    fun getUshuaia(): Destination {
        return Destination(
            ...
            listOf(
                "https://denomades.s3.us-west-2.amazonaws.com/blog/wp-content/uploads/2018/08/30192236/26824519578_6a65e00419_o.jpg",
                "https://assets.isu.pub/document-structure/230227205753-1d4950002a497fe2707e7f13d447b5cd/v1/5710027cd9b32bd9d95924309e92b887.jpeg",
                "https://i0.wp.com/elplanetaurbano.com/wp-content/uploads/2023/02/la_ciudad_fueguina_de_ushuaia.jpg"
            )
        )
    }
    ...
    fun getSalta(): Destination {
        return Destination(
            ...
            listOf(
                "https://eqfsewpc7rt.exactdn.com/wp-content/uploads/2022/01/que-ahcer-en-salta-dia-por-dia.jpeg",
                "https://elacopleinformativo.com.ar/wp-content/uploads/2023/03/Salta.jpg"
            )
        )
    }
    ...
    fun getCataratas(): Destination {
        return Destination(
            ...
            listOf(
                "https://www.fundacionaquae.org/wp-content/uploads/2016/01/800px_iguacu-002.jpg",
